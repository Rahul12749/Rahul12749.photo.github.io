  ...
  <header id="header" class="header d-flex align-items-center">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <div class="header-social-links">
        <a href="https://www.facebook.com/Camlensphotography?mibextid=LQQJ4d" class="facebook"><i class="bi bi-facebook"></i></a>
        <a href="https://instagram.com/camlens_clicks?igshid=YmMyMTA2M2Y=" class="instagram"><i class="bi bi-instagram"></i></a>
      </div>
        ...
        <div class="container" data-aos="fade-up">
          ...
          <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry" data-portfolio-sort="original-order">
            ...
            <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
                      ...
                      <?php 
                      $sqlq = "SELECT * FROM portfolio";
                      $resultq = mysqli_query($conn,$sqlq);
              if(mysqli_num_rows($resultq)>0){
                  while($fetch = mysqli_fetch_assoc($resultq)){
              ?>
                      <div class="col-lg-4 col-md-6 portfolio-item filter-wedding">
                        <div class="portfolio-content h-100">
                          <a href="gallery.php?name=<?php echo $fetch['name']; ?>" class="details-link">
                          <img src="upload/<?php echo $fetch['image'];?>" class="img-fluid" alt="">
                          <div class="portfolio-info">
                            <h4><?php echo $fetch['location'];?></h4>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                      <div class="footer__top__text">
                        ...
                        <div class="team__btn">
                            <a class="primary-btn normal-btn">Send Request</a>
                        </div>
                    </div>
                    </div>
                </div>
